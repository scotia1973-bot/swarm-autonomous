#!/bin/bash
echo "🔧 FINAL FIX - RUNNING ONCE"

# Kill everything local
pkill -f swarm 2>/dev/null
pkill -f cloudflared 2>/dev/null

# Create fresh working swarm with Render port support
cat > swarm_render.py << 'RENDEREOF'
#!/usr/bin/env python3
...
echo "✅ Fixed swarm created"

# Deploy to Render via their CLI
...
services:
  - type: web
    name: swarm-autonomous
    runtime: python
    buildCommand: pip install stripe
    startCommand: python3 swarm_render.py
    envVars:
...
# Add fresh remote
git remote add origin https://scottwishart@github.com/scottwishart/swarm-autonomous.git

# Force push
git add swarm_render.py render.yaml
git commit -m "Final working swarm"
git push -u origin main --force

echo ""
echo "========================================="
echo "✅ DONE - SWARM ON RENDER"
echo "========================================="
echo ""
echo "Your swarm is deploying to:"
echo "https://swarm-autonomous.onrender.com"
echo ""
echo "Check status in 2 minutes:"
echo "curl https://swarm-autonomous.onrender.com"
echo ""
echo "========================================="
