...
if os.path.exists(key_file):
    ...
    STRIPE_KEY = None
    print("⚠️ No Stripe key found")

CITIES = ["New York","Los Angeles","Chicago","Houston","Phoenix","Miami","Atlanta","Seattle","Denver","Boston","Toronto","Vancouver","Mexico City","Sao Paulo","Rio de Janeiro","Buenos Aires","Bogota","Santiago","Lima"]
...
def discover_niches(city):
    try:
        ...
        return [{'niche': 'emergency plumber', 'price': 350}]
...
print("💰 SWARM ONLINE")
print(f"📂 Pages will be saved to pages/")
